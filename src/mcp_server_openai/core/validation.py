...
class ImageRequest(BaseModel):
    ...
    width: Optional[int] = Field(None, ge=100, le=2048, description="Image width")
    height: Optional[int] = Field(None, ge=100, le=2048, description="Image height")
...
class IconRequest(BaseModel):
    ...
    color: Optional[str] = Field(None, description="Icon color (hex code)")
