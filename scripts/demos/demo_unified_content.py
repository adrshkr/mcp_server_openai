...
from mcp_server_openai.tools.unified_content_creator import CONTENT_STYLES, SUPPORTED_FORMATS, create_unified_content
...
async def demo_error_handling():
    ...
    test_cases = [
        {"name": "Empty Title", "title": "", "brief": "Test brief", "notes": ["Test note"]},
        {
        ...
        {"name": "No Notes", "title": "Test Title", "brief": "Test brief", "notes": []},
        {
            "name": "Invalid Format",
            "title": "Test Title",
            "brief": "Test brief",
